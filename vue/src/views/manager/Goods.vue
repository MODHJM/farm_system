  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      ...
      <el-table :data="data.tableData" stripe>
        ...
        <el-table-column label="库存量" prop="store"></el-table-column>
    ...
    <el-dialog title="农产品信息" width="40%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" label-width="100px" style="padding-right: 50px" ref="formRef" :rules="data.rules">
        ...
        <el-form-item label="单价" prop="price">
          <el-input type="number"  v-model="data.form.price" autocomplete="off" />
        </el-form-item>
        <el-form-item label="单位" prop="unit">
          <el-input  v-model="data.form.unit" autocomplete="off" />
        </el-form-item>
        <el-form-item label="库存" prop="store">
          <el-input-number   v-model="data.form.store" autocomplete="off" />
        </el-form-item>
